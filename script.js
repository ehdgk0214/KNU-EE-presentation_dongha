...
const majorsData = [
    ...
    {
        title: "모바일공학",
        desc: "스마트폰 및 태블릿 폼팩터에 최적화된 모바일 시스템 아키텍처와 최신 모바일 플랫폼 생태계를 연구합니다.",
...
const curriculumData = [
    {
        ...
        details: ["미적분학 및 공학수학 1, 2", "일반물리학 및 실험", "C언어 프로그래밍 기초", "전자공학 입문 세미나"]
    },
    {
        title: "2학년: 전공 핵심 진입",
    ...
    {
        title: "3학년: 심화 및 응용",
        desc: "8대 세부 전공별 심화 과목을 선택하여 본인만의 전문성을 기릅니다.",
